...
INSTRUCTIONS:
1. add your api key in app/llm.py
2. add text or data into data/sample.txt (books, scraped data, tweets, ect)
3. run main.py 
4. type questions into cli, type q to quit 
5. ai will respond only off of your sample text
